<?php
if(isset($_GET['fish_set_id']))
{
    $fish_set_id=$_GET['fish_set_id'];

   $query="select * from fish_set where fish_set_id=$fish_set_id";
     ...
     */
        ...
        {
            $query="update fish_set set fish_provider_name='$fish_provider_name',fish_quantity=$fish_quantity,fish_price=$fish_price,fish_weight=$fish_weight,fish_id=$fish_id,pond_id=$pond_id,user_id=$user_id,date=now() where fish_set_id=$fish_set_id";
