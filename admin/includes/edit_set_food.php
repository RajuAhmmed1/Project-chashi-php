...
//getting data from food-set table
    
if(isset($_GET['food_set_id']))
 {
    $food_set_id=$_GET['food_set_id'];

   $query="select * from food_set where food_set_id=$food_set_id";
    $select_query=mysqli_query($connection,$query);
    while($row=mysqli_fetch_assoc($select_query))
    {
        $food_provider_name=$row['client'];
     ...
     */
        ...
        {
            $query="update food_set set pond_id=$pond_id,food_id=$food_id,client='$food_provider_name',food_quantity=$food_quantity,food_price=$food_price,user_id=$user_id,date=now()";
