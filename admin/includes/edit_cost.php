...
if(isset($current_user_id))
{
    ...
    //getting cost data from cost table
     ...
     */
        ...
        {
            $query="update cost set cost_name='$cost_name',cost_amount=$cost_amount,pond_id=$pond_id,date=now(),user_id=$user_id where cost_id=$cost_id";
